...
![Desktop Mode: the apps menu, a terminal, and the on-screen keyboard driven by the trackpads](docs/images/desktop-demo.gif)
...
1. **Get the image.**
   ...
   **Prerelease, not yet tested on hardware:** [`v2026.09.24-fast-install-v2`](https://github.com/villenull/Pizzarchy/releases/tag/v2026.09.24-fast-install-v2). It asks which drive to use (internal SSD or microSD), whether you want Omarchy's pre-installs and Steam, downloads Steam with a progress bar, and installs while you answer. It passed every combination in a VM. It is split into four parts; the release notes show how to join and check them.
...
| **STEAM + right stick** ↔ | switch workspace 1…5 one at a time, one per flick — empty workspaces included, no wrapping: left from 1 and right from 5 do nothing |
| **A** / **B** | confirm / back |
