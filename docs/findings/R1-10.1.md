...
reading before writing any of it (`docs/findings/R1-10.2.md` covers where our copy
...
3. **The target's final `/etc/pacman.conf` is not omarchy-iso's.** The
   ...
   from getting them into the build — see `docs/findings/R1-10.2.md`, which found
