...
| P2.0e | **§5.18(a)** — the session-start retry thrash. `Relogin=true` absorbs it (600 autologin attempts across 20 switches), so a switch can flicker ~38s. Gate on the USER manager, not the seat | Deck | `docs/PROGRESS.md` §5.18 |
