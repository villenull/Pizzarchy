...
> `docs/PROGRESS.md` §3. §10.6's drafts are staged and held by operator choice.
...
Convert the six open questions in `docs/PLAN.md` §10 from hypotheses into
...
- **If confirmed, stop and surface it to the operator** before continuing.
  ...
  screen in `docs/PLAN.md` §6.1a item 7 more prominent.
...
- Also draft the five upstream bug reports for `aorumbayev/deckarchy` from
  `docs/PLAN.md` §8, each with its hypothesis and reproduction.
...
- [ ] `docs/PLAN.md` §10 updated in place to reflect findings
- [ ] `docs/PROGRESS.md` "Findings" section updated
